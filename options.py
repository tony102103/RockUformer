...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--dataset', type=str, default ='ROCK')
        ...
        parser.add_argument('--mode', type=str, default ='deblur',  help='image restoration mode')
        parser.add_argument('--dd_in', type=int, default=1, help='dd_in')   # NOTE: 1

        # args for saving 
        parser.add_argument('--save_dir', type=str, default ='./../logs',  help='save dir') # NOTE: 改成你想存放的路径
        parser.add_argument('--save_images', action='store_true',default=False)
        parser.add_argument('--env', type=str, default ='_888',  help='env')
        ...
        parser.add_argument('--train_dir', type=str, default ='./../datasets/deblur/train',  help='dir of train data')  # NOTE: 修改为实际路径
        parser.add_argument('--val_dir', type=str, default ='./../datasets/deblur/val',  help='dir of val data')    # NOTE: 修改为实际路径
